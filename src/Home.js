                ...
                <div className="divHomeSectionOne">
                    ...
                    <div className="divHomeSectionOneRight">
                        ...
                        <div className="divNavigationButtonArea">
                            <div className="Button"><img src="https://vectorified.com/images/home-icon-white-2.png" alt="" />
                                    <figcaption>Home</figcaption>
                            </div>
                            <div className="Button"><img src="https://nationalpid.com/wp-content/uploads/2018/07/about-us-icon-white.png" alt="" />
                                    <figcaption>Our Center</figcaption>
                            </div>
                            <div className="Button"><img src="https://iconsplace.com/wp-content/uploads/_icons/ffffff/256/png/package-icon-18-256.png" alt="" />
                                    <figcaption>Packages</figcaption>
                            </div>
                            <div className="Button"><img src="https://www.seekpng.com/png/full/137-1373765_phone-icon-white-contact-us-icon-transparent-white.png" alt="" />
                                    <figcaption>Contact Us</figcaption>
                            </div>
                            <div className="Button"><img src="https://www.drinkcraft.net/wp-content/uploads/2021/02/login-icon-white.png" alt="" />
